...
+ **CloudFront console** – Update the **Compress objects automatically** setting\. For more information, see [Creating a Web Distribution](distribution-web-creating-console.md)\.
