...
+ **Use an API:** The [ StartConfigurationRecorder](http://docs.aws.amazon.com/config/latest/APIReference/API_StartConfigurationRecorder.html) operation and other information in the *AWS Config API Reference*
