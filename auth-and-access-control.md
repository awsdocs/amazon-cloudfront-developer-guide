...
This chapter explains how to use [AWS Identity and Access Management \(IAM\)](http://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html) and CloudFront to help secure your resources\.
