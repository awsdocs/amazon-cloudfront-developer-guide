...
For the current quota on the number of headers that you can whitelist for each cache behavior or to request a higher quota, see [Quotas on headers](cloudfront-limits.md#limits-custom-headers)\.
