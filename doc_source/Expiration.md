...
For information about how to change settings for web distributions using the CloudFront console, see [Viewing and Updating CloudFront Distributions](HowToUpdateDistribution.md)\. For information about how to change settings for web distributions using the CloudFront API, see [PUT Config](http://docs.aws.amazon.com/cloudfront/latest/APIReference/API_PutConfig.html)\.
