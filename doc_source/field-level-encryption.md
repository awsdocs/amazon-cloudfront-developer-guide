...
CloudFront encrypts data fields by using the [AWS Encryption SDK](http://docs.aws.amazon.com/encryption-sdk/latest/developer-guide//introduction.html)\. The data remains encrypted throughout your application stack and can be accessed only by applications that have the credentials to decrypt it\. 
