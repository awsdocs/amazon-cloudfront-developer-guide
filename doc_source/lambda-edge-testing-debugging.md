...
+ **Check to see if the logs appear in CloudWatch\.** Make sure that you look in the Region where the Lambda@Edge function executed\. For more information, see Determine the Lambda@Edge Region\.
