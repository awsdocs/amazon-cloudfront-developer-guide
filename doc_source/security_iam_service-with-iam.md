# How Amazon CloudFront works with IAM<a name="security_iam_service-with-iam"></a>
...
## Identity\-based policies for CloudFront<a name="security_iam_service-with-iam-id-based-policies"></a>
...
### Identity\-based policy examples for CloudFront<a name="security_iam_service-with-iam-id-based-policies-examples"></a>
...
## Resource\-based policies within CloudFront<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for CloudFront<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
## Policy resources for CloudFront<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for CloudFront<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## ACLs in CloudFront<a name="security_iam_service-with-iam-acls"></a>
...
## ABAC with CloudFront<a name="security_iam_service-with-iam-tags"></a>
...
## Using temporary credentials with CloudFront<a name="security_iam_service-with-iam-roles-tempcreds"></a>
...
## Cross\-service principal permissions for CloudFront<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for CloudFront<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked roles for CloudFront<a name="security_iam_service-with-iam-roles-service-linked"></a>
