...
### Size Limits on URI and Query String<a name="lambda-at-the-edge-URI-size-limits-lambda-at-edge"></a>
...
### Size Limits on Request Body with the Include Body Option<a name="lambda-at-the-edge-body-size-limits-lambda-at-edge"></a>
...
#### Size Limits when Exposing the Body to a Lambda Function<a name="lambda-at-the-edge-exposing-body-size-limits-lambda-at-edge"></a>
...
#### Size Limits when Returning a Request Body from a Lambda Function<a name="lambda-at-the-edge-returning-body-size-limits-lambda-at-edge"></a>
